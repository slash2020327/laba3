package com.solvd.qa.gui.ios.components;
...
public class ProductSlider extends BaseComponent implements IScrollUtilsIOS {
    ...
    public void moveSlider() {
        mobileSwipeScreenIOS(IMobileUtils.Direction.LEFT);
    }
