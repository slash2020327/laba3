...
public class HomePageTest extends BaseTest {
    ...
    public void verifySalesHits() {
        ...
        JavaScriptUtils.scrollDown(getDriver(), 5);
        ...
        for (String salesHitsName : salesHitsNames) {
            Assert.assertEquals(salesHitsName, salesHits.getProductByName(salesHitsName).getProductName(), "Sales hits don't match");
        }
    }
}
